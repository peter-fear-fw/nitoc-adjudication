      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">NITOC Adjudication Tracker</h1>
            <p className="mt-2 text-sm text-gray-500">Sign in to manage debate adjudications</p>
          </div>
